...
public class ClothArmorMaterial implements IArmorMaterial {
    ...
    public ClothArmorMaterial() {
        this.name = "cloth";
        this.maxDamageFactor = 4;
        this.damageReductionAmountArray = new int[] { 1, 1, 1, 1 };
